...
public class Monopoly extends JApplet
{
	...
	*/
	...
	class Menu extends JPanel
	{
		...
		private JLabel startText = new JLabel(icon, JLabel.CENTER);
		...
		public Menu()
		{
			...
			title.setFont(new Font("Cooper Black", Font.BOLD, 60));
			startText.setFont(new Font("Cooper Black", Font.BOLD, 18));
			...
			menu.setLayout(new GridLayout(1,3,60,10));
			menu.setOpaque(true);
			menu.setBackground(new Color(178,247,178));
			startText.setPreferredSize(new Dimension(225, 225));
			menu.add(startText);
			add(menu);
